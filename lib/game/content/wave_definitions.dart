...
const moonlitAbandonedOfficeWaves = <WaveDefinition>[
  ...
  WaveDefinition(
    ...
    startSpawnsPerSecond: 3.4,
    endSpawnsPerSecond: 4.6,
    groupSize: 6,
    startEliteChance: 0.07,
    endEliteChance: 0.11,
    startMaxActiveEnemies: 68,
    endMaxActiveEnemies: 86,
  ),
  WaveDefinition(
    startSecond: 240,
    endSecond: 270,
    ...
    eliteWeights: {brokenJangseungSpirit: 1, sorrowfulMaidenGhost: 1},
    startSpawnsPerSecond: 4.6,
    endSpawnsPerSecond: 6.8,
    groupSize: 8,
    startEliteChance: 0.11,
    endEliteChance: 0.15,
    startMaxActiveEnemies: 86,
    endMaxActiveEnemies: 96,
  ),
  WaveDefinition(
    startSecond: 270,
    endSecond: 330,
...
const plagueMarketWaves = <WaveDefinition>[
  ...
  WaveDefinition(
    ...
    startSpawnsPerSecond: 5.0,
    endSpawnsPerSecond: 7.2,
    groupSize: 6,
