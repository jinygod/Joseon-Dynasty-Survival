...
- [x] **Step 1: Write failing round-trip and mapping tests**
...
- [x] **Step 3: Implement immutable records and backward-compatible decoding**
...
- [x] **Step 1: Write failing accumulator tests**
...
- [x] **Step 2: Run tracker tests and verify RED**
...
- [x] **Step 5: Connect game events and verify GREEN**
...
- [x] **Step 3: Implement repository and verify GREEN**
...
- [x] **Step 3: Add dependency and implement service**
...
- [x] **Step 4: Wire `GameScreen` and verify GREEN**
...
- [x] **Step 5: Update documentation and TODO evidence**
...
- [x] **Step 6: Commit and run full gate**
